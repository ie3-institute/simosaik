...
public class DefaultPrimaryResultSimulator extends MosaikSimulator {
    ...
    public Map<String, Object> init(String sid, Float timeResolution, Map<String, Object> simParams) {
        return Meta.createMeta(
                ...
                Model.withoutParams(PRIMARY_INPUT_ENTITIES, true, MOSAIK_ACTIVE_POWER, MOSAIK_REACTIVE_POWER, MOSAIK_VOLTAGE_DEVIATION),
                Model.withoutParams(RESULT_OUTPUT_ENTITIES, true, MOSAIK_ACTIVE_POWER, MOSAIK_REACTIVE_POWER, MOSAIK_VOLTAGE_DEVIATION)
        );
    }
